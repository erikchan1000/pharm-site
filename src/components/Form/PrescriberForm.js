...
export default function PrescriberForm({formId, buttonId}) {
    ...
    const form3 = (
        <>
            <TextField id={buttonId} label="Name" variant="filled" className="fields" size="small"/>
            <TextField id={buttonId} label="Clinic" variant="filled" className="fields" size="small"/>
            <FormControl variant="standard" className='phone'>
